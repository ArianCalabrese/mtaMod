...
function colorPicker.create(id, start, title)
  ...
  cp.gui.window = guiCreateWindow(11,184, cp.gui.width, cp.gui.height, tostring(title or "COLORPICKER"), false)
  centerGUI ( cp.gui.window )
...
function colorPicker:render()
  ...
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "files/cursor.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "files/cursor.png", 0, 0, 0, self.color.huecurrent, self.gui.focus)
